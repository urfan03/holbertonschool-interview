...
'''This script determines if all boxes can be opened in a scenario with boxes containing keys to other boxes.'''
...
def canUnlockAll(boxes):
    ...
    while stack:
        ...
        for key in boxes[current_box]:
            # If the key opens a box that hasn't been visited yet, add it to the stack

...
This function is used only for visualization purposes. You don’t have to push it to your repo. It may not be used during the correction. [print](https://github.com/holbertonschool/0x1C.c/)

## Task

**0. Is AVL**

File: [0-binary_tree_is_avl.c](0-binary_tree_is_avl.c/) - [0-main.c](0-main.c/)
